...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n====== Convert model to ONNX done ======")

        onnx_input_path = onnx_path
        pb_output_path = pb_path
        print("\n====== Converting ONNX to tf pb ======")
        onnx2pb(onnx_input_path, pb_path)
        print("\n====== Convert ONNX to tf pb done ======")
